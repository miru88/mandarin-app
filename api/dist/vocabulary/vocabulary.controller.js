...
let VocabularyController = class VocabularyController {
    ...
    addWords(newVocabularyWord) {
        this.vocabularyService.addNewWord(newVocabularyWord);
    }
    updateWord(vocabularyToUpdate) {
...
__decorate([
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [vocabulary_dto_1.UpdateVocabularyDto]),
    __metadata("design:returntype", void 0)
], VocabularyController.prototype, "updateWord", null);
